# The Wealth Gallery
An interactive museum where you speak with history's greatest financial minds.
Built at WEHack 2026 — won **Best Use of ElevenLabs** (Major League Hacking).

**Tech:** HTML/CSS/JS · Gemini API · ElevenLabs · Firebase Auth · Vercel

**Live demo:** [The Wealth Gallery](https://we-hack2026-navy.vercel.app/)
...
### Voice Narration
- Persona greets the user with a voice intro created using **ElevenLabs**   
...
- ElevenLabs-powered voice narration for each chatbot response
...
## Team
Built in 24 hours during WEHack 2026.
